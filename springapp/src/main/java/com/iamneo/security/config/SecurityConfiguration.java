...
public class SecurityConfiguration {
    ...
    // Add this bean to enable CORS configuration
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .sessionCreationPolicy(SessionCreationPolicy.STATELESS)
                .and()
                .authenticationProvider(authenticationProvider) // Here we need to tell Spring which authentication provider we are going to use
